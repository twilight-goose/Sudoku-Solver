...
Description: Basic Sudoku interface with solving algorithm. User can input their own grid
            and the program can show the candidates numbers by toggling a button, and the program
...
def main():
    ...
    grid = classes.Grid([[0] * 9] * 9, show_conflicts=False, show_candidates=False)
    ...
    show_button = ui.Button("Show candidates", (502, 175))
            ...
            if event.type == pygame.QUIT:
                ...
                if x in range(25, 475) and y in range(25, 475):
                    ...
                    if y in range(25, 75):
                        ...
                        grid = classes.Grid(HARDEST_GRID, show_candidates=False)
